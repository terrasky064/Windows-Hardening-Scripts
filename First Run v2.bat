...
goto MENU
:Three
echo "Output done, changing pswd policies!"
net accounts /minpwlen:10
net accounts /maxpwage:30
net accounts /minpwage:5
echo "Current Policy- Minimum password length: 10 characters; Max password age: 30 days; Min Password age: 5 days."
PAUSE
net accounts
goto MENU
:Four
echo "Finding inappropriate media files..."
@echo off
color 0f
cls
